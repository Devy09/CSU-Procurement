...
export default function ProcurementDashboard() {
  ...
  const handlePrintProcurementReport = async () => {
    if (!metrics) return;
    ...
    try {
      ...
      link.href = url;
      link.download = `procurement-report-${period}-${new Date().toISOString().split('T')[0]}.pdf`;
    ...
    <div className="min-h-screen p-8 bg-background">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button onClick={handlePrintProcurementReport}>
            Generate Report
          </Button>
        </div>
      </div>
