                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Select value={section} onValueChange={setSection}>
                                ...
                                <SelectContent>
                                    <SelectItem value="CETC">CETC</SelectItem>
                                    <SelectItem value="CAS">CAS</SelectItem>
                                    <SelectItem value="CBPA">CBPA</SelectItem>
                                    <SelectItem value="CETD">CETD</SelectItem>
                                    <SelectItem value="CAFI">CAFI</SelectItem>
                                    <SelectItem value="CAFO">CAFO</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
